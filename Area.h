#pragma once
#ifndef	__Area_h__
#define	__Area_h__	2.1
#ident	"@(#)Area.h	2.1	AKK	20120724"
...
public:
	...
	int		getEnd()  const { return ends; }	///< Vertel het laatste adres binnen het gebied
	...
	/// Sorting functor for Area's
	class orderByAddress
	{
	public:
		inline 	/// "Call" operator to compare two areas
